...
public:
	...
	// Bar线合成, baseKline: 基础周期K线, period: 基础周期(m1/m5/day), times: 周期倍数, sInfo: 交易时间模板, bIncludeOpen: 是否包含未闭合的K线
	...
	// 秒K合成, ayTicks: tick数据, seconds: 目标周期, sInfo: 交易时间模板, bUnixTime: tick时间戳是否是unixtime
